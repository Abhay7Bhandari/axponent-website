      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, #0a0f1a 0%, #111827 40%, #1a0a0a 100%)",
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 80% 50%, rgba(200,80,20,0.25) 0%, transparent 60%)",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 20% 60%, rgba(0,80,200,0.12) 0%, transparent 50%)",
            }}
          />
          ...
          >
            ...
            {/* Arm reaching in */}
            <path
              d="M260 160 Q320 140 360 180 Q380 195 375 220 Q370 240 340 248"
              stroke="#c8956a"
              strokeWidth="42"
              strokeLinecap="round"
              fill="none"
            ...
            <ellipse
              ...
              ry="14"
              fill="#c8956a"
              transform="rotate(-20,348,248)"
            />
            <path
              d="M335 240 Q345 230 360 238"
              stroke="#b07850"
              strokeWidth="6"
              strokeLinecap="round"
              fill="none"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {cards.map((card, i) => (
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(0,50,160,0.22) 0%, rgba(5,10,40,0.9) 100%)",

...
function AdvertisersHero() {
  return (
    <section className="relative min-h-[50vh] flex flex-col items-center justify-center text-center px-4 pt-28 pb-16 overflow-hidden">
      ...
      <div className="stars" />
      <FadeSection>
        <h1 className="font-display font-bold text-5xl sm:text-6xl md:text-7xl text-white mb-6 leading-tight">
          PARTNERS/<span style={{ color: '#00A8FF' }}>ADVERTISERS</span>
        </h1>
        <p className="text-gray-400 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
          Axponent partners with trusted global measurement, media, and technology platforms to deliver
          transparent, scalable, performance-driven campaigns worldwide.
        </p>
      </FadeSection>
    </section>
  )
  ...
  const cards = [
    {
      ...
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00A8FF" strokeWidth="1.8">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex border-b border-white/10 mb-8">
            {[
              { key: 'measurement', label: 'Measurement & Attribution Partners' },
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, rgba(5,20,80,0.6) 0%, rgba(2,8,40,0.8) 100%)',
          ...
          >
            ...
            <div className="md:w-1/3 flex-shrink-0">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Axponent collaborates with a global ecosystem of trusted partners to deliver transparent,
                scalable, and performance-driven campaigns across every market.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-3">
                Ad fraud costs the industry billions each year as budgets shift to digital. Fraudsters inflate apps
                by serving ads with little or no chance of being seen by real users.
              </p>
              <p className="text-gray-400 text-sm leading-relaxed">
                Axponent protects your campaigns with advanced verification and brand-safe inventory, ensuring
                your ad spend delivers real impact.
              </p>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="px-3 flex flex-col gap-2 mt-1">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="flex gap-2 items-start">
                      <div className="w-8 h-8 rounded flex-shrink-0" style={{ background: 'rgba(30,50,120,0.6)' }} />
                      <div className="flex-1 flex flex-col gap-1">
                        <div className="h-2 rounded" style={{ background: 'rgba(255,255,255,0.15)', width: '80%' }} />
                        <div className="h-2 rounded" style={{ background: 'rgba(255,255,255,0.08)', width: '60%' }} />
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {/* Right – format list */}
            <div>
              <h2 className="font-display font-bold text-4xl text-white mb-8">Ad Format</h2>
                ...
                {formats.map((fmt) => (
                  <button
                    ...
                    style={{
                      ...
                      background: activeFormat === fmt ? 'rgba(0,80,200,0.15)' : 'transparent',
                      border: activeFormat === fmt ? '1px solid rgba(0,120,255,0.3)' : '1px solid transparent',
                    }}
                  >
                    {fmt}
                  </button>
    ...
    <section className="relative py-24 px-4 overflow-hidden">
      ...
      <div
        ...
        style={{
          width: '100%',
          height: '260px',
          background: 'radial-gradient(ellipse at center bottom, rgba(0,100,255,0.45) 0%, rgba(0,50,150,0.2) 40%, transparent 75%)',
          filter: 'blur(10px)',
        }}
      />
      <div
      ...
      <div className="hidden lg:flex flex-col items-center gap-2 fixed right-6 top-1/2 -translate-y-1/2 z-10">
        <span className="text-gray-500 text-xs tracking-widest" style={{ writingMode: 'vertical-rl' }}>
          SCROLL DOWN
        </span>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input
              ...
              onBlur={(e) => (e.target.style.borderColor = 'rgba(0,100,255,0.25)')}
            />
            <input
              name="email"
              type="email"

      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">Built with clarity. Designed for flow.</p>
            ...
            >
              ...
              <button
                ...
                style={{ background: 'linear-gradient(90deg,#0060FF,#0090FF)', borderRadius: '0 6px 6px 0' }}
              >
                Submit
              </button>
            </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                <svg className="text-brand-blue mt-0.5 flex-shrink-0" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,12 2,6" />
                </svg>
                <a href="mailto:info@axpoennt.com" className="text-gray-400 text-sm hover:text-brand-blue transition-colors">
                  info@axpoennt.com
                </a>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm leading-relaxed">
                  Axponent, 706-707, 7th Floor Tower A, Iris Tech Park, Sector 48, Sohna Road,
                  Gurugram, India, Pin – 122018
                </span>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm leading-relaxed">
                  Axponent Media -FZCO, Dubai Silicon Oasis, DDP, Building A1, Dubai, AE
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-gray-600 text-xs">© 2025 Axponent. All Rights Reserved.</p>
          <button
            onClick={scrollToTop}
